...
int main(int argc, char *argv[])
{
    ...
    int numberOfPackets = 24; //initial 10
    ...
    while(1){
        ...
        //CHECK IF THE PACKET HAS TO BE DROPPED BASED ON LIST IN INPUT ARGUMENT
        if (sequenceNumber == dropNum[c] && c < 10 && argc > 2){
            ...
            //NORMAL scenario
            if (sequenceNumber >= last_frame_received && sequenceNumber <= last_frame_received+1+receive_window_size){
